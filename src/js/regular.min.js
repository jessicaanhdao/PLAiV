...
!function() {
	...
	} catch (c) {} const h=(c.navigator||{}).userAgent; const v=void 0===h?'':h; const l=c; const m=z; const s=(l.document, !!m.documentElement&&!!m.head&&'function'==typeof m.addEventListener&&m.createElement, ~v.indexOf('MSIE')||v.indexOf('Trident/'), '___FONT_AWESOME___'); const M=function() {
		try {
			return !0
		} catch (c) {
			return !1
		}
	}(); const a=l||{}; a[s]||(a[s]={}), a[s].styles||(a[s].styles={}), a[s].hooks||(a[s].hooks={}), a[s].shims||(a[s].shims=[]); const H=a[s]; function V(c, v) {
		const z=(2<arguments.length&&void 0!==arguments[2]?arguments[2]:{}).skipHooks; const h=void 0!==z&&z; const l=Object.keys(v).reduce(function(c, z) {
			const h=v[z]; return h.icon?c[h.iconName]=h.icon:c[z]=h, c
			...
			for (let c=1; c<arguments.length; c++) {
				var m=null!=arguments[c]?arguments[c]:{}; let z=Object.keys(m); 'function'==typeof Object.getOwnPropertySymbols&&(z=z.concat(Object.getOwnPropertySymbols(m).filter(function(c) {
					...
					let z; let h; let v; z=l, v=m[h=c], h in z?Object.defineProperty(z, h, {value: v, enumerable: !0, configurable: !0, writable: !0}):z[h]=v
				})
			} return l
