...
!function() {
	...
	} catch (c) {} const l=(c.navigator||{}).userAgent; const h=void 0===l?'':l; const v=c; const m=z; const M=(v.document, !!m.documentElement&&!!m.head&&'function'==typeof m.addEventListener&&m.createElement, ~h.indexOf('MSIE')||h.indexOf('Trident/'), '___FONT_AWESOME___'); const a=function() {
		try {
			return !0
		} catch (c) {
			return !1
		}
	}(); const s=v||{}; s[M]||(s[M]={}), s[M].styles||(s[M].styles={}), s[M].hooks||(s[M].hooks={}), s[M].shims||(s[M].shims=[]); const f=s[M]; function H(c, h) {
